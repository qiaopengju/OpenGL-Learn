...
int main(){
    ...
    Shader shaderColorCube("Shaders/lightingMap.vert", "Shaders/lightingMap.frag");
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        shaderColorCube.setVec3("light.diffuse", colorLight[0], colorLight[1], colorLight[2]);
        ...
        ImGui::Begin("Configure"); {
            ...
            ImGui::SliderFloat3("Diffuse", colorLight, 0.0f, 1.0f);
