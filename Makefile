...
SOURCES = ResourceManager.cpp Model.cpp Shader.cpp Texture.cpp BasicObjectRender.cpp
SOURCES += $(GLAD)
...
#debug:
#	@echo $(OBJS)
all: $(EXE) $(INCLUDE) $(SOURCES) main.o	#当前进度
	clang++ -o $(EXE) $(CLANG_FLAG) $(LIBS) $(OBJS) main.o
	./$(EXE)
dirShadow: $(INCLUDE) $(SOURCES) 0_dirLightShadow.o
	clang++ -o $(EXE) $(CLANG_FLAG) $(LIBS) $(OBJS) 0_dirLightShadow.o
	./$(EXE)
########################
#Build rules
########################
